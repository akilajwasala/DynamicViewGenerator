...
- (void)viewDidLoad {
    ...
    inFrame = CGRectMake (([UIScreen mainScreen].bounds.size.width - viewContainer.frame.size.width),0,menuWidth,[UIScreen mainScreen].bounds.size.height);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self closeMenu];
    if ([_delegate respondsToSelector:@selector(rightMenuItemSelectedAtIndex:)]) {
        [_delegate rightMenuItemSelectedAtIndex:indexPath.row];
    }
}
